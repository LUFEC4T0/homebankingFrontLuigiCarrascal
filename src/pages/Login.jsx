    ...
    return (
        <>
            <div className="bg-gray-500 flex flex-1 flex-col justify-center items-center">
                <div>
                <h1 className="font-bold text-5xl text-white p-5 bg-indigo-500 rounded-lg shadow-xl shadow-black-500">Welcome to Banco Luigi!</h1>
                </div>
                <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl overflow-hidden sm:flex sm:px-2 sm:flex-col sm:justify-center sm:items-center m-8">
                    <div className="md:flex w-full sm:flex">
                        ...
                        <form onSubmit={handleLogin} className="w-full md:w-1/2 py-10 px-5 md:px-10 ">
                            ...
                            <div className="flex flex-col -mx-3">
                                <div className="w-full px-3 mb-5 sm:w-[90%] sm:flex md:w-[90%] md:flex">
                                ...
                                <div>
                                        <p className="text-sm text-center">Don't have an account yet? <a href="/register" className="text-indigo-500 hover:text-indigo-700 font-semibold">Sign Up</a>.</p>
                                </div>
                            </div>
                        </form>
                    </div>
