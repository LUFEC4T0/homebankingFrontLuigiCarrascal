                    ...
                    axios.post('http://localhost:8080/api/auth/login', {email:userData.email, password:userData.password})
                        .then(res => {
                            ...
                            axios.get("http://localhost:8080/api/clients/current", {
                                ...
                                .then(response => {
                                    dispacth(current(response.data));
                                    navigate('/accounts')
                                })
            ...
            <div className="bg-gray-500 flex flex-1 flex-col justify-center items-center">
                ...
                <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl overflow-hidden sm:flex sm:px-2 sm:flex-col sm:justify-center sm:items-center sm:w-3/4 m-8">
                    <div className="md:flex w-full sm:flex">
                        ...
                        <form onSubmit={handleLogin}  className="w-full md:w-1/2 py-10 px-5 md:px-10">
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input value={userData.firstName} name='firstName' onInput={handleInput} type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John"></input>
                                        </div>
                                    </div>
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                            <input value={userData.lastName} name='lastName' onInput={handleInput} type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith"></input>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input value={userData.email} name='email' onInput={handleInput} type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com"></input>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-12">
                                        ...
                                        <div className="flex">
                                            ...
                                            <input value={userData.password} name='password' onInput={handleInput} type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************"></input>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex flex-col -mx-3">
                                    <div className="w-full px-3 mb-5 sm:w-[90%] sm:flex md:w-[95%] md:flex ">
                                    ...
                                    <div>
                                        <p className="text-sm text-center">Already have an account? <a href="/login" className="text-indigo-500 hover:text-indigo-700 font-semibold">Login</a>.</p>
                                    </div>
                                </div>
                            </div>
                        </form>
